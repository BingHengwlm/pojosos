...
_keytable1.1:
	...
	DB	0
LC3:
	DB	0xD6,0xDC,0xC8,0xD5,0x00
LC4:
	DB	0xD6,0xDC,0xD2,0xBB,0x00
LC5:
	DB	0xD6,0xDC,0xB6,0xFE,0x00
LC6:
	DB	0xD6,0xDC,0xC8,0xFD,0x00
LC7:
	DB	0xD6,0xDC,0xCB,0xC4,0x00
LC8:
	DB	0xD6,0xDC,0xCE,0xE5,0x00
LC9:
	DB	0xD6,0xDC,0xC1,0xF9,0x00
	ALIGNB	4
LC10:
	DD	LC3
	DD	LC4
...
_HariMain:
	...
	MOV	DWORD [-1856+EBP],-1
	MOV	DWORD [-1860+EBP],0
	MOV	DWORD [-1864+EBP],2147483647
	MOV	DWORD [-1868+EBP],0
	MOV	DWORD [-1888+EBP],0
	MOV	AL,BYTE [4081]
	SAR	AL,4
	MOV	EDX,EAX
	AND	EDX,7
	MOV	DWORD [-1892+EBP],EDX
	MOV	DWORD [-1896+EBP],-1
	MOV	DWORD [-1900+EBP],-1
	MOV	DWORD [-1904+EBP],-1
	MOV	DWORD [-1908+EBP],0
...
L17:
	...
	CALL	_io_sti
	POP	EBX
	CMP	DWORD [-1916+EBP],0
	JE	L24
	MOV	EDX,DWORD [-1916+EBP]
	CMP	DWORD [28+EDX],0
	JNE	L24
	MOV	EDX,DWORD [-1844+EBP]
	MOV	DWORD [-1916+EBP],0
	...
	POP	ECX
L24:
	MOV	EDX,DWORD [-1840+EBP]
	LEA	EAX,DWORD [-256+EDX]
	CMP	EAX,255
	JA	L27
	CMP	EDX,383
	JG	L28
	CMP	DWORD [-1888+EBP],0
	JNE	L29
...
L42:
	...
	JE	L99
L43:
	CMP	DWORD [-1840+EBP],325
	JE	L100
L44:
	CMP	DWORD [-1840+EBP],326
	JE	L101
L45:
	CMP	DWORD [-1840+EBP],315
	JE	L102
L46:
	CMP	DWORD [-1840+EBP],316
	JE	L103
L48:
	CMP	DWORD [-1840+EBP],343
	JE	L104
L50:
	MOV	EAX,DWORD [-1840+EBP]
	CMP	EAX,506
...
L99:
	...
	JMP	L43
L98:
	AND	DWORD [-1888+EBP],-3
	JMP	L42
L97:
	AND	DWORD [-1888+EBP],-2
	JMP	L41
L96:
	OR	DWORD [-1888+EBP],2
	JMP	L40
...
L59:
	...
	JE	L60
	CMP	DWORD [-1900+EBP],0
	JS	L109
	MOV	ESI,DWORD [-1848+EBP]
	MOV	EAX,DWORD [-1908+EBP]
	SUB	ESI,DWORD [-1900+EBP]
	MOV	EDI,DWORD [-1852+EBP]
	SUB	EDI,DWORD [-1904+EBP]
	MOV	EDX,DWORD [-1852+EBP]
	LEA	ESI,DWORD [2+ESI+EAX*1]
	MOV	DWORD [-1904+EBP],EDX
	MOV	DWORD [-1864+EBP],ESI
	ADD	DWORD [-1868+EBP],EDI
	AND	DWORD [-1864+EBP],-4
	JMP	L53
L109:
	MOV	EAX,DWORD [-1844+EBP]
	MOV	EAX,DWORD [16+EAX]
	MOV	EBX,EAX
	MOV	DWORD [-1924+EBP],EAX
	DEC	EBX
	TEST	EBX,EBX
	JLE	L53
L73:
	...
	ADD	EAX,ESI
	MOV	ECX,DWORD [EDX]
	MOV	DWORD [-1928+EBP],EAX
	MOV	EDX,DWORD [20+EDX]
	MOV	EAX,DWORD [-1928+EBP]
